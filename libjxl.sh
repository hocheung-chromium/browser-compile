...
git fetch https://chromium.googlesource.com/chromium/src refs/changes/56/4257656/86 && git cherry-pick FETCH_HEAD &&
...
git fetch https://chromium.googlesource.com/devtools/devtools-frontend refs/changes/82/4257582/47 && git cherry-pick FETCH_HEAD &&
