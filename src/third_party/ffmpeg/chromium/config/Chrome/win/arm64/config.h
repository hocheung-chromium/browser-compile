 ...
 * --disable-linux-perf --x86asmexe=nasm --optflags='\"-O2\"' --toolchain=msvc
 * --extra-cflags=-I/usr/local/google/home/dalecurtis/code/chrome/src/third_party/ffmpeg/chromium/include/win
 * --enable-cross-compile --cc=clang-cl --ld=lld-link --nm=llvm-nm --ar=llvm-ar
 * --extra-cflags=-O2 --arch=aarch64 --as=clang-cl
 * --extra-cflags='--target=arm64-windows'
 * --extra-cflags=/winsysroot/usr/local/google/home/dalecurtis/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/27370823e7
 * --extra-ldflags='/winsysroot:/usr/local/google/home/dalecurtis/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/27370823e7'
 * --enable-decoder='aac,h264,hevc' --enable-demuxer=aac
 * --enable-parser='aac,h264,hevc'" -- elide long configuration string from
 * binary */
