 ...
 * --disable-autodetect --enable-decoder='vorbis,libopus,flac'
 ...
 * --extra-cflags=-I/usr/local/google/home/dalecurtis/code/chrome/src/third_party/opus/src/include
 * --disable-linux-perf --x86asmexe=nasm --optflags='\"-O2\"' --enable-pic
 * --cc=clang --cxx=clang++ --ld=clang --enable-cross-compile --cc=clang
 * --ld=ld64.lld --nm=llvm-nm --ar=llvm-ar --target-os=darwin
 * --extra-cflags='--target=arm64-apple-macosx'
 * --extra-cflags=-F/usr/local/google/home/dalecurtis/code/chrome/src/build/mac_files/xcode_binaries/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks
 * --extra-cflags='-mmacosx-version-min=10.10' --extra-cflags=-fblocks
 * --extra-cflags=-nostdinc
 * --extra-cflags=-isystem/usr/local/google/home/dalecurtis/code/chrome/src/build/mac_files/xcode_binaries/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include
 * --extra-cflags=-isystem/usr/local/google/home/dalecurtis/code/chrome/src/third_party/llvm-build/Release+Asserts/lib/clang/19/include
 * --extra-ldflags=-syslibroot
 * --extra-ldflags=/usr/local/google/home/dalecurtis/code/chrome/src/build/mac_files/xcode_binaries/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
 * --extra-ldflags=-L/usr/local/google/home/dalecurtis/code/chrome/src/build/mac_files/xcode_binaries/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/lib
 ...
 * --extra-ldflags='-arch arm64' --enable-decoder='aac,h264,hevc'
 * --enable-demuxer=aac --enable-parser='aac,h264,hevc'" -- elide long
...
/* #define HAVE_VFP_ARGS 0 -- softfp/hardfp selection is done by the chrome
 * build */
