 ...
 * --enable-avutil --enable-fft --enable-rdft --enable-static --enable-libopus
 * --disable-bzlib --disable-error-resilience --disable-iconv --disable-lzo
 ...
 * --disable-alsa --disable-autodetect --enable-decoder='vorbis,libopus,flac'
 ...
 * --extra-cflags=-I/cygdrive/d/chromium/src/third_party/opus/src/include
 * --disable-linux-perf --x86asmexe=yasm --optflags='\"-O2\"'
 * --enable-decoder='theora,vp8' --enable-parser='vp3,vp8' --toolchain=msvc
 * --extra-cflags=-I/cygdrive/d/chromium/src/third_party/ffmpeg/chromium/include/win
 * --cc='cygwin-wrapper cl' --ld='cygwin-wrapper link' --nm='cygwin-wrapper
 * dumpbin -symbols' --ar='cygwin-wrapper lib' --enable-decoder='aac,h264,hevc'
 * --enable-demuxer=aac --enable-decoder='aac,h264,hevc'" -- elide long
