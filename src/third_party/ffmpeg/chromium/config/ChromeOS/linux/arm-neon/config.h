 ...
 * --extra-cflags=-O2 --enable-neon --extra-cflags='-mfpu=neon' --enable-pic
 * --cc=clang --cxx=clang++ --ld=clang --extra-ldflags='-fuse-ld=lld'
 * --enable-decoder='aac,h264,hevc' --enable-demuxer=aac
 * --enable-parser='aac,h264,hevc' --enable-decoder=mpeg4
