 ...
 * --disable-bzlib --disable-iconv --disable-network --disable-schannel
 * --disable-sdl2 --disable-symver --disable-xlib --disable-zlib
 * --disable-securetransport --disable-faan --disable-alsa --disable-autodetect
 ...
 * --disable-linux-perf --x86asmexe=nasm --optflags='\"-O2\"'
 * --enable-cross-compile --cross-prefix=/usr/bin/aarch64-linux-gnu-
 * --extra-cflags='--target=aarch64-linux-gnu'
 * --extra-ldflags='--target=aarch64-linux-gnu' --target-os=linux
 * --sysroot=/usr/local/google/home/dalecurtis/code/chrome/src/build/linux/debian_bullseye_arm64-sysroot
 * --disable-dotprod --disable-i8mm --arch=aarch64 --enable-armv8
 * --extra-cflags='-march=armv8-a' --enable-pic --cc=clang --cxx=clang++
 * --ld=clang --extra-ldflags='-fuse-ld=lld' --enable-decoder='aac,h264,hevc'
 * --enable-demuxer=aac --enable-parser='aac,h264,hevc' --enable-decoder=mpeg4
 * --enable-parser='h263,mpeg4video' --enable-demuxer=avi" -- elide long
