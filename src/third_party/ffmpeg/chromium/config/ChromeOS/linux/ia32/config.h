 ...
 * --disable-linux-perf --x86asmexe=nasm --optflags='\"-O2\"' --arch=i686
 * --extra-cflags='\"-m32\"' --extra-ldflags='\"-m32\"' --enable-pic --cc=clang
 * --cxx=clang++ --ld=clang --enable-decoder='aac,h264,hevc'
